...
public class Test {
    ...
    private static void testResize(Client client) {
        client.executeAction("resize", "1", "2");
        client.executeAction("resize", "1", "3");
        client.executeAction("resize", "1", "222");
        client.executeAction("change color", "1", "ROZ MAGENTA DESCHIS");
        client.executeAction("change text", "1", "smth");
